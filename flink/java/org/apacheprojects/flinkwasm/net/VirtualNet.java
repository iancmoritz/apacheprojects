...
public final class VirtualNet {
  ...
  /**
   * Routes plain {@code java.net} sockets through this loopback as well as NIO channels.
   *
   * <p>Must run before anything constructs a socket -- the JDK only lets the factories be set once.
   */
  public static void installSocketFactories() throws IOException {
    VirtualSocketImpl.install();
  }
